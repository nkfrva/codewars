...
/// of an integer for the person's age and an integer for the person's 
/// handicap.
///Output
///Output will consist of a list of string values (in Haskell and 
///C: Open or Senior) stating whether the respective member is to 
...
public class CategorizeNewMember
{
    ...
    //public static IEnumerable<string> OpenOrSenior(int[][] data) => 
    //    data.Select(member => member[0] >= 55 && member[1] > 7 ? 
    //    "Senior" : "Open").ToList();
}
